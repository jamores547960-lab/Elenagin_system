    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-indigo-800 text-white flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-2">
                <a href="<?php echo e(route('cashier.dashboard')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg bg-indigo-700 hover:bg-indigo-600 transition">
                ...
                <a href="<?php echo e(route('cashier.sales')); ?>?period=day" class="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-indigo-700 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <form id="pos-form" action="<?php echo e(route('cashier.process')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Sydney Jagape\kerk\resources\views/cashier/dashboard.blade.php ENDPATH**/ ?>