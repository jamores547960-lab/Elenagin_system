...
<?php $__env->startSection('title', 'Automated Reports - Elenagin System'); ?>
        ...
        <div class="report-card">
            ...
            <div class="report-stats">
                <div class="stat-item">
                    ...
                    <span class="stat-value"><?php echo e($dailyReportCount); ?></span>
                </div>
                <div class="stat-item">
                    <span class="stat-label">Last Generated:</span>
                    <span class="stat-value"><?php echo e($dailyReportCount > 0 ? 'Today' : 'Never'); ?></span>
                </div>
            </div>
        ...
        <div class="report-card">
            ...
            <div class="report-stats">
                <div class="stat-item">
                    ...
                    <span class="stat-value"><?php echo e($weeklyReportCount); ?></span>
                </div>
                <div class="stat-item">
                    <span class="stat-label">Week Period:</span>
                    <span class="stat-value"><?php echo e(now()->startOfWeek()->format('M d')); ?> - <?php echo e(now()->endOfWeek()->format('M d')); ?></span>
                </div>
            </div>
        ...
        <div class="report-card">
            ...
            <div class="report-stats">
                <div class="stat-item">
                    ...
                    <span class="stat-value"><?php echo e($monthlyReportCount); ?></span>
                </div>
                <div class="stat-item">
                    <span class="stat-label">Month:</span>
                    <span class="stat-value"><?php echo e(now()->format('F Y')); ?></span>
                </div>
            </div>
...
<?php echo $__env->make('system', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sydney Jagape\kerk\resources\views/reports/automated.blade.php ENDPATH**/ ?>