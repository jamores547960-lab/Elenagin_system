...
<?php $__env->startSection('title', 'Spoilage Details - TITLE'); ?>
...
<div class="details-card">
    <div class="detail-section">
        ...
        <div class="detail-row">
            ...
            <div class="detail-value"><?php echo e($spoilage->stockout_id); ?></div>
        </div>

        <div class="detail-row">
            <div class="detail-label">Date:</div>
            <div class="detail-value"><?php echo e($spoilage->stockout_date->format('F d, Y')); ?></div>
        </div>

        <div class="detail-row">
            <div class="detail-label">Recorded By:</div>
            <div class="detail-value"><?php echo e($spoilage->user->name ?? 'N/A'); ?></div>
        </div>

        <div class="detail-row">
            <div class="detail-label">Created At:</div>
            <div class="detail-value"><?php echo e($spoilage->created_at->format('F d, Y h:i A')); ?></div>
        </div>
    </div>
    ...
    <div class="detail-section">
        ...
        <div class="detail-row">
            ...
            <div class="detail-value"><?php echo e($spoilage->item->item_id); ?></div>
        </div>

        <div class="detail-row">
            <div class="detail-label">Product Name:</div>
            <div class="detail-value"><strong><?php echo e($spoilage->item->name); ?></strong></div>
        </div>

        <div class="detail-row">
            <div class="detail-label">Category:</div>
            <div class="detail-value"><?php echo e($spoilage->item->category->name ?? 'N/A'); ?></div>
        </div>

        <div class="detail-row">
            <div class="detail-label">Quantity Removed:</div>
            <div class="detail-value"><?php echo e($spoilage->quantity); ?></div>
        </div>

        <div class="detail-row">
            <div class="detail-label">Current Stock:</div>
            <div class="detail-value"><?php echo e($spoilage->item->quantity); ?></div>
        </div>
    </div>
    ...
    <div class="detail-section">
        ...
        <div class="detail-row">
            ...
            <div class="detail-value">
                <?php if($spoilage->notes): ?>
                    <?php echo e($spoilage->notes); ?>
...
<?php echo $__env->make('system', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sydney Jagape\kerk\resources\views/spoilage/show.blade.php ENDPATH**/ ?>